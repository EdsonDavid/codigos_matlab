...
Ee   = 2000e6;       % modulo de elasticidad del solido (Pa) = 2 KPa
...
X_c = @(theta)1000*(1 + (theta*pi/180));Y_c =@(theta)1000*(theta*pi/180)^2;
%elem lado  tix     tiy     tjx     tjy     tkx     tky     tlx    tly
carga_distr = [ ...
  4   2673  X_c(0)  Y_c(0)  X_c(10) Y_c(10) X_c(20) Y_c(20) X_c(30) Y_c(30)  
  8   2673  X_c(30) Y_c(30) X_c(40) Y_c(40) X_c(50) Y_c(50) X_c(60) Y_c(60)  
 12   2673  X_c(60) Y_c(60) X_c(70) Y_c(70) X_c(80) Y_c(80) X_c(90) Y_c(90)];
...
for i = 1:nlcd
   ...
   carga = carga_distr(i,3:10);
   fte = t2ft_T10(xnod(LaG(e,1:10),[X Y]), lado, carga, te);  
